...
- recorded that switch-class devices were dual-modeled in code at the time of the initial mapping; later implementation work narrowed the current runtime surface to `switch.py`,
